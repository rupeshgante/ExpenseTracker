...
axios.post('http://3.94.195.113:7000/user/addexpense',
    expensedetails,
...
getdata.addEventListener('click',()=>{
    ...
    document.getElementById('rows').value=row;
      ...
      axios.get('http://3.94.195.113:7000/user/getexpense',{params: { page:1,rows:row },headers:{Authentication:token}})
                 .then(res=>{
                    console.log(res);
...
page.addEventListener('click',(e)=>{
    ...
    axios.get('http://3.94.195.113:7000/user/getexpense',{params: { page:pageno,rows:row },headers:{Authentication:token}})
        // axios.get(`http://3.94.195.113:7000/user/getexpense/${pageno}`,{headers:{Authentication:token}})
           .then(res=>{
            console.log(res);
...
//DELETE EXPENSE
    ...
    del.addEventListener('click',async()=>{
        try{
        await axios.delete(`http://3.94.195.113:7000/user/deleteexpense/${data.id}`,{headers:{Authentication:token},data:{amount:data.amount}})
             li.remove();
        }
        catch(err){
            console.log(err);
...
//PREMIUM MEMBERSHIP
    ...
    premium.addEventListener('click',async(e)=>{
        ...
        const response= await axios.get('http://3.94.195.113:7000/user/premiummembership',{headers:{Authentication:token}});
        var options=
        {
            ...
            "handler":function(response){
                console.log('sent');
                axios.post('http://3.94.195.113:7000/user/updatetransaction',{
            ...
            window.location.assign('http://127.0.0.1:5500/BACK-END/public/premium.html')
...
if(localStorage.getItem('premium')==1){
    ...
    leaderboard.addEventListener('click',(e)=>{
        ...
        {
            axios.get('http://3.94.195.113:7000/user/getalluser',{headers:{Authentication:token}})
            .then(res=>{
                const data=res.data;
...
// SHOWING LEADER BOARD
   ...
   function display(id){
    ...
    axios.get('http://3.94.195.113:7000/user/getoneexpense',{params: { user_id:id },headers:{Authentication:token}})
    .then(res=>{
        console.log(res);
    ...
    logout.addEventListener('click',()=>{
        localStorage.clear();
        window.location.assign('http://127.0.0.1:5500/BACK-END/public/login.html')
